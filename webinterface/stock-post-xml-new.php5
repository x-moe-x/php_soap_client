...
require_once ROOT . 'api/ApiStock.class.php';
...
$smarty -> assign('data', ApiStock::getStockData($page, $rp, $sortname, $sortorder, $filter_items, $filter_itemNumbers, $filter_itemNames, $filter_marking1ID));
$smarty -> display('stock-post.tpl');
?>
