...
CREATE TABLE `soap_db`.`PriceSets` (
	...
	`PackagingUnit` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
	...
	`Unit1` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
	`Unit2` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
